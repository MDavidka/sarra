    ...
    return {
        ...
        "agent_session": {
            ...
            "sycord_change_flow": [
                ...
                "5. Syte matches UUID → workspace, auto-starts OpenHands Agent Server if needed",
                "6. Syte sends the message to the persistent OpenHands conversation",
                "7. Native WebSocket events become request_completed / message_snapshot activity events",
            ],
            "activity_api": {
