...
def build_ai_spec(base_url: str = "") -> dict:
    ...
    return {
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/api/agent_settings", "auth": True, "body": {"uuid": "str", "model_profile": "syra-nano|syra-ultra|syra-havy"}},
            ...
            {"method": "GET", "path": "/api/ai/solar/status", "auth": False, "description": "Legacy Solar/Ollama model cleanup status"},
            {"method": "DELETE", "path": "/api/ai/solar", "auth": False, "description": "Remove the legacy Qwen 2.5 Coder model from this VM"},
        ...
        "agent_session": {
            ...
            "model_profiles": {
                ...
                "syra-ultra": "Air — Aliyun Qwen3.7-Plus (qwen3.7-plus, cost-capped)",
                "syra-havy": "Metal — VyceAI Claude Sonnet 4.6 (claude-sonnet-4-6)",
            },
            "thinking_level": thinking_levels_spec(),
            "gui_configuration": (
                "Syte GUI → AI tab — internal secret, per-profile API keys, estimated token prices, "
            ...
            "tools": [
                ...
                "mcp_credentials", "call_external_api",
            ],
            "code_policy": {
