...
def build_ai_spec(base_url: str = "") -> dict:
    ...
    return {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/api/ai/solar/status", "auth": False, "description": "Solar VM installation and Qwen 2.5 Coder 3B running state"},
            {"method": "POST", "path": "/api/ai/solar/setup", "auth": False, "description": "Install Ollama, download Qwen 2.5 Coder 3B, and start the local AI API"},
        ...
        "agent_session": {
            ...
            "model_profiles": {
                ...
                "syra-solar": "Solar VM — Ollama Qwen 2.5 Coder 3B (local)",
            },
