...
def build_ai_spec(base_url: str = "") -> dict:
    ...
    return {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/api/agent_status?uuid=", "auth": True, "description": "OpenCode agent status + agent_proxy_url"},
            {"method": "POST", "path": "/api/agent_start", "auth": True, "body": {"uuid": "str"}, "description": "Start OpenCode serve agent"},
            ...
            {"method": "GET", "path": "/api/agent_logs?uuid=&lines=200", "auth": True, "description": "OpenCode serve log snapshot"},
            ...
            {"method": "GET", "path": "/api/projects/{uuid}/agent/logs/stream?live=1", "auth": "optional", "description": "SSE OpenCode agent logs"},
            {"method": "POST", "path": "/api/tokens", "auth": False, "body": {"name": "str"}, "description": "Create API key (GUI)"},
        ],
        "agent_session": {
            "description": "Per-project OpenCode serve runtime for long-lived AI coding sessions. Independent from preview/deploy.",
            ...
            "sycord_change_flow": [
                ...
                "2. sycord.com opens SSE GET /api/internal/projects/{uuid}/agent/activity/stream?live=1",
                "3. sycord.com POST /api/internal/projects/{uuid}/agent/change {message, model_name}",
                "4. Syte streams activity events (thinking, file edits, commands) to the SSE client",
                "5. Syte matches UUID → workspace, starts opencode serve if needed",
                "6. Syte POST /session/:id/message with user prompt",
                "7. Poll /session/status until idle, emit request_completed, return reply to sycord.com",
            ],
            "activity_api": {
            ...
            "workflow": [
                ...
                "3. Use agent_proxy_url for OpenCode HTTP API (not raw localhost port)",
            ...
            "errors": {
                ...
                "agent_start_failed": "OpenCode CLI not installed or config invalid",
                "backend_unreachable": "Bridge API base not reachable",
                "cli_not_installed": "npm install -g opencode-ai",
