...
def build_ai_spec(base_url: str = "") -> dict:
    ...
    return {
        ...
        "endpoints": [
            ...
            {"method": "GET", "path": "/api/agent_skills?uuid=", "auth": True, "description": "List built-in skills + active state/parameters for a project"},
            ...
            {"method": "GET", "path": "/api/projects/{uuid}/agent/skills", "auth": False, "description": "GUI mirror — list/enable/disable skills"},
        ...
        "agent_session": {
            ...
            "artifacts": {
                ...
                "skills": "GET /api/agent_skills?uuid= ; enable/edit via agent_skills_enable ; disable via agent_skills_disable",
            },
            "workflow": [
